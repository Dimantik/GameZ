...
public class Place implements BDInterface, Owner {
    ...
    public static Place createNewPlace(int id, String name, int dangerousLevel, int protection, String info, String assertDrawableName, List<Resource.ResourceType> resourceTypeList){
        Place place = getBasePlace(id, name, dangerousLevel, protection, info, assertDrawableName, resourceTypeList);
    ...
    public static Place getInstance(int id, String name, int dangerousLevel, int protection, String info, String assertDrawableName, List<Resource.ResourceType> resourceTypeList, Set<UUID> resourceUUIDList){
        Place place = getBasePlace(id, name, dangerousLevel, protection, info, assertDrawableName, resourceTypeList);
    ...
    private static Place getBasePlace(int id, String name, int dangerousLevel, int protection, String info, String assertDrawableName, List<Resource.ResourceType> resourceTypeList){
        ...
        place.setProtection(protection);
